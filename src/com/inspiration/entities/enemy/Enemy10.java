...
public class Enemy10 extends Entity {
	...
	public Enemy10(int x, int y, int width, int height, BufferedImage sprite) {
		super(x, y, width, height, null);

		leftEnemy = new BufferedImage[2];
		leftEnemy[0] = Game.spritesheet.getSprite(13*16, 9*16, 16, 16);
		leftEnemy[1] = Game.spritesheet.getSprite(14*16, 9*16, 16, 16);

		rightEnemy = new BufferedImage[2];
		rightEnemy[0] = Game.spritesheet.getSprite(13*16, 10*16, 16, 16);
		rightEnemy[1] = Game.spritesheet.getSprite(14*16, 10*16, 16, 16);
