...
public class Enemy2 extends Entity {
	...
	public Enemy2(int x, int y, int width, int height, BufferedImage sprite) {
		...
		leftEnemy[0] = Game.spritesheet.getSprite(17*16, 2*16, 16, 16);
		leftEnemy[1] = Game.spritesheet.getSprite(18*16, 2*16, 16, 16);

		rightEnemy = new BufferedImage[2];
		rightEnemy[0] = Game.spritesheet.getSprite(17*16, 3*16, 16, 16);
		rightEnemy[1] = Game.spritesheet.getSprite(18*16, 3*16, 16, 16);
