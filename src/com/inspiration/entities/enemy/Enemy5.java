...
public class Enemy5 extends Entity {
	...
	private int frames = 0, maxFrames = 40, index = 0, maxIndex = 1;
	...
	public Enemy5(int x, int y, int width, int height, BufferedImage sprite) {
		super(x, y, width, height, null);

		enemy = new BufferedImage[2];
		enemy[0] = Game.spritesheet.getSprite(14*16, 4*16, 16, 16);
		enemy[1] = Game.spritesheet.getSprite(15*16, 4*16, 16, 16);
	...
	public boolean isColidding(int xnext, int ynext) {
		...
		for (int i = 0; i < Game.enemies5.size(); i++) {
			Enemy5 e = Game.enemies5.get(i);
			if (e == this)
				continue;
