...
public class Enemy8 extends Entity {
	...
	public Enemy8(int x, int y, int width, int height, BufferedImage sprite) {
		super(x, y, width, height, null);

		leftEnemy = new BufferedImage[2];
		leftEnemy[0] = Game.spritesheet.getSprite(13*16, 5*16, 16, 16);
		leftEnemy[1] = Game.spritesheet.getSprite(14*16, 5*16, 16, 16);

		rightEnemy = new BufferedImage[2];
		rightEnemy[0] = Game.spritesheet.getSprite(13*16, 6*16, 16, 16);
		rightEnemy[1] = Game.spritesheet.getSprite(14*16, 6*16, 16, 16);
	...
	public boolean isColidding(int xnext, int ynext) {
		...
		for (int i = 0; i < Game.enemies8.size(); i++) {
			Enemy8 e = Game.enemies8.get(i);
			if (e == this)
				continue;
